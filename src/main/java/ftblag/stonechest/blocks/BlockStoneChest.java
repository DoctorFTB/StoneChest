...
public class BlockStoneChest extends ChestBlock {
    ...
    public BlockStoneChest(EnumStoneChest chestType, ResourceKey<Block> key) {
        super(() -> SCRegistry.CHEST_BLOCK_ENTITY_TYPE.get(), SoundEvents.CHEST_OPEN, SoundEvents.CHEST_CLOSE, Properties.of().strength(2.5F).sound(SoundType.STONE).setId(key));
