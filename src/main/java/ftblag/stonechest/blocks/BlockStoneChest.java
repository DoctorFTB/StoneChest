...
public class BlockStoneChest extends ChestBlock {
    ...
    public BlockStoneChest(EnumStoneChest chestType, ResourceKey<Block> key) {
        super(() -> SCRegistry.CHEST_BLOCK_ENTITY_TYPE, SoundEvents.CHEST_OPEN, SoundEvents.CHEST_CLOSE, Properties.of().strength(2.5F).sound(SoundType.STONE).setId(key));
        this.chestType = chestType;
    }

    @Override
    public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new BlockEntityStoneChest(this.chestType, blockPos, blockState);
    }
