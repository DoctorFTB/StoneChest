...
public class SCRegistry {
    ...
    public static void register(IEventBus modEventBus) {
        ...
        CHEST_BLOCK_ENTITY_TYPE = BLOCK_ENTITIES.register("chest_tile", () -> BlockEntityType.Builder.of(BlockEntityStoneChest::new, Arrays.stream(chests).map(DeferredHolder::get).toArray(Block[]::new)).build(null));
